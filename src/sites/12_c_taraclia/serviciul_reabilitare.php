...
<head>
    ...
    <meta name="description" content="<?php echo t('rehabilitation_meta_description'); ?>">
    <meta name="keywords" content="<?php echo t('rehabilitation_meta_keywords'); ?>">
                ...
                <div class="content-wrapper">
                    <div class="service-hero">
                        <div class="service-hero-content">
                            <h2><?php echo t('rehabilitation_about_title'); ?></h2>
                    ...
                    <!-- <div class="service-gallery">
                        <h2><?php echo t('rehabilitation_gallery_title'); ?></h2>
