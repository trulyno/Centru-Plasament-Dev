            ...
            <div class="header-top-container" id="headerTopContainer">
                ...
                <div class="header-contact">
                    <div class="contact-info-header">
                        <div class="contact-item-header">
                            ...
                            <div>
                                ...
                                <a href="tel:029424594">029 424 594</a>
                            </div>
                        </div>
                        <div class="contact-item-header">
                    ...
                    <div class="donate-section">
                        ...
                        <button class="audio-btn" id="socialBtn" aria-label="<?php echo t('social_facebook'); ?>"  onclick="window.open('https://www.facebook.com/groups/2293107404329291/', '_blank');">
                            <i class="fab fa-facebook-f"></i>
                ...
                <ul class="nav-menu" id="navMenu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="serviciul_social.php"><?php echo t('services_social'); ?></a></li>
                            <li><a href="serviciul_psihopedagogic.php"><?php echo t('services_psycho_pedagogical'); ?></a></li>
                            <li><a href="serviciul_reabilitare.php"><?php echo t('services_rehabilitation'); ?></a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
