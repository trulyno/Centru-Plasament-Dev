...
<head>
    ...
    <meta name="description" content="<?php echo t('social_meta_description'); ?>">
    <meta name="keywords" content="<?php echo t('social_meta_keywords'); ?>">
    <meta name="author" content="<?php echo t('site_title'); ?>">

    <title><?php echo t('social_page_title'); ?></title>
            ...
            <div class="container">
                <div class="content-wrapper">
                        ...
                        <div class="services-list">
                            <div class="service-item">
                                ...
                                <div class="service-content">
                                    <h4><?php echo t('social_service_accommodation_title'); ?></h4>
                                    <p><?php echo t('social_service_accommodation_desc'); ?></p>
                                </div>
                            </div>
                            <div class="service-item">
                                <div class="service-icon">
                    ...
                    <!-- <div class="service-gallery">
                        <h2><?php echo t('social_gallery_title'); ?></h2>
