            ...
            <div class="header-top-container" id="headerTopContainer">
                ...
                <div class="header-contact">
                    <div class="contact-info-header">
                        <div class="contact-item-header">
                            ...
                            <div>
                                ...
                                <a href="tel:023041523">023 041 523</a>
                            </div>
                        </div>
                        <div class="contact-item-header">
                            ...
                            <div>
                                ...
                                <a href="mailto:internatbad@gmail.com">internatbad@gmail.com</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="donate-section">
                        ...
                        <button class="audio-btn" id="socialBtn" aria-label="<?php echo t('social_facebook'); ?>" onclick="window.open('https://www.facebook.com/profile.php?id=100064560951058', '_blank');">
                            <i class="fab fa-facebook-f"></i>
