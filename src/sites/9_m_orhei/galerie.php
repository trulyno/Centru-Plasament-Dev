            ...
            <div class="container">
                <div class="gallery">
                    ...
                    <div class="gallery-grid">
                        ...
                        image('24.jpg', 'activities', '', '');
                        image('25.jpg', 'activities', '', '');
                        image('26.jpg', 'activities', '', '');
                        image('27.jpg', 'activities', '', '');
                        image('28.jpg', 'activities', '', '');
                        image('29.jpg', 'activities', '', '');
                        image('30.jpg', 'activities', '', '');
                        image('31.jpg', 'activities', '', '');
                        image('32.jpg', 'activities', '', '');
                        image('33.jpg', 'activities', '', '');
