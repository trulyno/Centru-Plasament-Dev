            ...
            <div class="header-top-container" id="headerTopContainer">
                ...
                <div class="header-contact">
                    <div class="contact-info-header">
                        <div class="contact-item-header">
                            ...
                            <div>
                                ...
                                <a href="tel:024852580">024 852 580</a>
                            </div>
                        </div>
                        <div class="contact-item-header">
                    ...
                    <div class="donate-section">
                        ...
                        <button class="audio-btn" id="socialBtn" aria-label="<?php echo t('social_facebook'); ?>" onclick="window.open('https://www.facebook.com/internat.psihoneurologic/', '_blank');">
                            <i class="fab fa-facebook-f"></i>
