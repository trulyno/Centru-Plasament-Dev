...
<head>
    ...
    <meta name="description" content="<?php echo t('recreational_meta_description'); ?>">
    <meta name="keywords" content="<?php echo t('recreational_meta_keywords'); ?>">
    <meta name="author" content="<?php echo t('site_title'); ?>">

    <title><?php echo t('recreational_page_title'); ?></title>
...
<body>
    ...
    <main class="main-content" id="main-content">
        <section class="page-header">
            <div class="container">
                <h1><?php echo t('activities_recreational'); ?></h1>
                ...
                <div class="content-wrapper">
                    <div class="service-hero">
                        <div class="service-hero-content">
                            <h2><?php echo t('activities_recreational_about_title'); ?></h2>
