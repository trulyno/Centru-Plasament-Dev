            ...
            <div class="about-content">
                <div class="about-left">
                    ...
                    <div class="about-tabs">
                        ...
                        <button class="about-tab-btn" data-tab="transparency"><?php echo t('about_tab_transparency'); ?></button>
                    </div>
                    ...
                    <div class="about-text-container">
                        ...
                        <div class="about-text fade-in about-tab-content" id="transparency">
                            <p><?php echo t('about_text_4'); ?></p>
                        </div>
                    </div>
                </div>
