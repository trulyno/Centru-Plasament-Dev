            ...
            <div class="header-top-container" id="headerTopContainer">
                ...
                <div class="header-contact">
                    <div class="contact-info-header">
                        <div class="contact-item-header">
                            ...
                            <div>
                                ...
                                <a href="tel:023030581">023 030 581</a>
                            </div>
                        </div>
                        <div class="contact-item-header">
                    ...
                    <div class="donate-section">
                        ...
                        <button class="audio-btn" id="socialBtn" aria-label="<?php echo t('social_facebook'); ?>"  onclick="window.open('https://www.facebook.com/profile.php?id=100080434905180', '_blank');">
                            <i class="fab fa-facebook-f"></i>
