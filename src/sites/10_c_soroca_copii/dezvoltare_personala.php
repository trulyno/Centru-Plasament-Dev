...
<head>
    ...
    <meta name="description" content="<?php echo t('development_meta_description'); ?>">
    <meta name="keywords" content="<?php echo t('development_meta_keywords'); ?>">
    <meta name="author" content="<?php echo t('site_title'); ?>">

    <title><?php echo t('development_page_title'); ?></title>
...
<body>
    ...
    <main class="main-content" id="main-content">
        <section class="page-header">
            <div class="container">
                <h1><?php echo t('personal_development'); ?></h1>
                ...
                <div class="content-wrapper">
                    <div class="service-hero">
                        <div class="service-hero-content">
                            <h2><?php echo t('personal_development_about_title'); ?></h2>
