                ...
                <div class="content-wrapper">
                    <div class="service-hero">
                        ...
                        <div class="service-hero-image">
                            <img src="images/reabilitare1.jpg" alt="Secția Reabilitare" loading="lazy">
                        </div>
                    </div>
                    ...
                    <div class="service-gallery">
                        ...
                        <div class="gallery-grid">
                            <div class="gallery-item">
                                <img src="images/reabilitare0.jpg" alt="" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/reabilitare5.jpg" alt="" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/reabilitare7.jpg" alt="" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/reabilitare2.jpg" alt="" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/reabilitare6.jpg" alt="" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/reabilitare9.jpg" alt="" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4></h4>
                                </div>
                            </div>
