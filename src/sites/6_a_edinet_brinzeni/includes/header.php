            ...
            <div class="header-top-container" id="headerTopContainer">
                ...
                <div class="header-contact">
                    <div class="contact-info-header">
                        <div class="contact-item-header">
                            ...
                            <div>
                                ...
                                <a href="tel:024659340">024 659 340</a>
                            </div>
                        </div>
                        <div class="contact-item-header">
                            ...
                            <div>
                                ...
                                <a href="mailto:cp.brinzeni@agssi.md">cp.brinzeni@agssi.md</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="donate-section">
                        ...
                        <button class="audio-btn" id="socialBtn" aria-label="<?php echo t('social_facebook'); ?>"  onclick="window.open('https://www.facebook.com/share/1SbshAcNgt/', '_blank');">
                            <i class="fab fa-facebook-f"></i>
