...
<head>
    ...
    <meta name="description" content="<?php echo t('methodologies_meta_description'); ?>">
    <meta name="keywords" content="<?php echo t('methodologies_meta_keywords'); ?>">
    <meta name="author" content="<?php echo t('meta_author'); ?>">
    
    <title><?php echo t('methodologies_page_title'); ?></title>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="document-card">
                        ...
                        <div class="document-content">
                            <h3>Standarde minime de calitate ale serviciilor prestate de centru</h3>
                            <a href="files/Standarde minime de calitate.pdf" class="document-link" target="_blank">
