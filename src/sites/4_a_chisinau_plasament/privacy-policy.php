            ...
            <div class="container">
                <div class="content-wrapper">
                    <div class="privacy-content">
                        ...
                        <h2>1. Introducere</h2>
                        <p>Centrul de Plasament pentru Persoanele Vârstnice („noi", CPPVPD") respectă confidențialitatea datelor dumneavoastră personale și se angajează să le protejeze în conformitate cu Regulamentul General privind Protecția Datelor (GDPR) și legislația națională aplicabilă.</p>
                        ...
                        <ul>
                            <li><strong>Consimțământul:</strong> pentru cookie-urile de analiză</li>
                        ...
                        <ul>
                            <li><strong>Email:</strong> cp.chisinau@agssi.md</li>
                            <li><strong>Adresa:</strong> Strada Valea Redului 16, mun. Chișinău</li>
                            <li><strong>Telefon:</strong> 022 796 086</li>
                        </ul>
