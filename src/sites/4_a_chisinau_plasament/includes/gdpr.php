...
class GDPRManager {
    ...
    public static function renderFooterConsentSection() {
        if (self::hasAnyConsent()) {
            return '';
        }
        
        return '
        <div id="gdpr-footer-section" class="gdpr-footer-section">
            <div class="gdpr-footer-content">
                <button type="button" class="gdpr-footer-close" onclick="dismissGDPRFooter(); return false;" aria-label="Close GDPR notice">
                    <i class="fas fa-times"></i>
                </button>
                <div class="gdpr-footer-text">
                    <h4>' . t('gdpr_banner_title') . '</h4>
                    <p>' . t('gdpr_banner_description') . '</p>
                </div>
                <div class="gdpr-footer-actions">
                    <a href="#" class="gdpr-footer-link gdpr-footer-link-primary" onclick="openGDPRModal(); return false;">
                        ' . t('gdpr_customize_settings') . '
                    </a>
                    <a href="#" class="gdpr-footer-link gdpr-footer-link-accept" onclick="acceptAllCookies(); return false;">
                        ' . t('gdpr_accept_all') . '
                    </a>
                    <a href="#" class="gdpr-footer-link gdpr-footer-link-reject" onclick="rejectAllCookies(); return false;">
                        ' . t('gdpr_reject_all') . '
                    </a>
                </div>
            </div>
