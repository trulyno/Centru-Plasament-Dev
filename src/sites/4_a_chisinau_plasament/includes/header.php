            ...
            <div class="header-top-container" id="headerTopContainer">
                ...
                <div class="header-contact">
                    <div class="contact-info-header">
                        <div class="contact-item-header">
                            ...
                            <div>
                                ...
                                <a href="tel:022796086">022 796 086</a>
                            </div>
                        </div>
                        <div class="contact-item-header">
                            ...
                            <div>
                                ...
                                <a href="mailto:cp.chisinau@agssi.md">cp.chisinau@agssi.md</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="donate-section">
                        ...
                        <button class="audio-btn" id="socialBtn" aria-label="<?php echo t('social_facebook'); ?>"  onclick="window.open('https://www.facebook.com/profile.php?id=100057233778392', '_blank');">
                            <i class="fab fa-facebook-f"></i>
        ...
        <div class="nav-container">
            <div class="logo-mobile">
                <a href="index.php" style="display: flex; align-items: center; color: inherit; text-decoration: none;">
                    <img src="images/01_symbol_guvernul.png  " alt="Logo CPPVPD" class="logo-mobile-image">
                    <i class="fas fa-heart"></i>
