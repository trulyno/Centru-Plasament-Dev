...
<head>
    ...
    <meta name="description" content="<?php echo t('ethics_code_meta_description'); ?>">
    <meta name="keywords" content="<?php echo t('ethics_code_meta_keywords'); ?>">
    <meta name="author" content="<?php echo t('meta_author'); ?>">
    
    <title><?php echo t('ethics_code_page_title'); ?></title>
...
<body>
    ...
    <main class="main-content" id="main-content">
        <section class="page-header">
            <div class="container">
                <h1><?php echo t('ethics_code_title'); ?></h1>
                <p><?php echo t('ethics_code_subtitle'); ?></p>
            </div>
        </section>
        ...
        <section class="content-section">
            <div class="container">
                <div class="content-wrapper">
                    ...
                    <?php
                        document('files/Codul Etic.pdf', 'Codul etic al angajaților Centrului de Plasament pentru Persoane Vârstnice și Persoane cu Dizabilități, mun. Chișinău');
                    ?>
                </div>
            </div>
        </section>
