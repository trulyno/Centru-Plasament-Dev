                            ...
                            <div class="document-content">
                                ...
                                <div class="document-details">
                                    <div class="detail-item">
                                        ...
                                        <span>Ultima actualizare: Octombrie 2022</span>
                                    </div>
                                    <div class="detail-item">
                                        <i class="fas fa-user-check"></i>
                                        <span>Aprobat prin Ordinul Directorului CPTPD (adulte), mun. Bălți</span>
                                    </div>
                                </div>
                                <a href="files/Regulamentul intern de organizare și funcționare a Centrului.pdf" class="document-link" target="_blank">
                                    <i class="fas fa-external-link-alt"></i> Vezi document
                                </a>
                            </div>
                        </div>
