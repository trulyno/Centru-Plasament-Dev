            ...
            <div class="header-top-container" id="headerTopContainer">
                ...
                <div class="header-contact">
                    <div class="contact-info-header">
                        <div class="contact-item-header">
                            ...
                            <div>
                                ...
                                <a href="tel:023171003">023 171 003</a>
                            </div>
                        </div>
                        <div class="contact-item-header">
                            ...
                            <div>
                                ...
                                <a href="mailto:cptr.balti@agssi.md">cptr.balti@agssi.md</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="donate-section">
                        ...
                        <button class="audio-btn" id="socialBtn" aria-label="<?php echo t('social_facebook'); ?>" onclick="window.open('https://www.facebook.com/centrul.de.plasament.temporar.si.reabili', '_blank');">
                            <i class="fab fa-facebook-f"></i>
                ...
                <ul class="nav-menu" id="navMenu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="serviciul_zi.php"><?php echo t('services_day'); ?></a></li>
                            <li><a href="serviciul_supraveghere.php"><?php echo t('services_watch'); ?></a></li>
                            <li><a href="serviciul_maternal.php"><?php echo t('services_maternal'); ?></a></li>
                            <li><a href="serviciul_plasament.php"><?php echo t('services_placement'); ?></a></li>
                            <li><a href="serviciul_zi_4m_3y.php"><?php echo t('services_day_4m_3y'); ?></a></li>
                            <li><a href="serviciul_interventie.php"><?php echo t('services_intervention'); ?></a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
