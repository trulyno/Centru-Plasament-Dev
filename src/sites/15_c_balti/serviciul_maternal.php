                    ...
                    <div class="service-gallery">
                        ...
                        <div class="gallery-grid">
                            <div class="gallery-item">
                                <img src="images/centru maternal/20220225_110340.jpg" alt="<?php echo t('services_maternal'); ?>" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4><?php echo t('services_maternal'); ?></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/centru maternal/20241226_110458.jpg" alt="<?php echo t('services_maternal'); ?>" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4><?php echo t('services_maternal'); ?></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/centru maternal/20241226_113036.jpg" alt="<?php echo t('services_maternal'); ?>" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4><?php echo t('services_maternal'); ?></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/centru maternal/3ae3ff0b-beb4-4438-97c8-c82d08bd5dabphoto.jpeg" alt="<?php echo t('services_maternal'); ?>" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4><?php echo t('services_maternal'); ?></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/centru maternal/7dac7c5d-7bbf-4737-beb4-f423cc2b0e68photo.jpeg" alt="<?php echo t('services_maternal'); ?>" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4><?php echo t('services_maternal'); ?></h4>
                                </div>
                            </div>
