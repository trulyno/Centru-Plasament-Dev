...
<body>
    ...
    <main class="main-content" id="main-content">
        <section class="page-header">
            <div class="container">
                <h1><?php echo t('services_placement'); ?></h1>
                ...
                <div class="content-wrapper">
                    <div class="service-hero">
                        <div class="service-hero-content">
                            <h2><?php echo t('placement_about_title'); ?></h2>
                    ...
                    <div class="service-gallery">
                        ...
                        <div class="gallery-grid">
                            ...
                            <div class="gallery-item">
                                <img src="images/cu plasamen planif/25.jpg" alt="<?php echo t('services_placement'); ?>" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4><?php echo t('services_placement'); ?></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/cu plasamen planif/26.jpg" alt="<?php echo t('services_placement'); ?>" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4><?php echo t('services_placement'); ?></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/cu plasamen planif/IMG_4555.jpeg" alt="<?php echo t('services_placement'); ?>" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4><?php echo t('services_placement'); ?></h4>
                                </div>
                            </div>
                            <div class="gallery-item">
                                <img src="images/cu plasamen planif/IMG_4561.jpeg" alt="<?php echo t('services_placement'); ?>" loading="lazy">
                                <div class="gallery-overlay">
                                    <h4><?php echo t('services_placement'); ?></h4>
                                </div>
                            </div>
