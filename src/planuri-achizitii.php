...
<head>
    ...
    <meta name="description" content="Planurile anuale de achiziții ale Centrului de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă.">
    <meta name="keywords" content="planuri achiziții, planificare, buget achiziții">
    <meta name="author" content="Centrul de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă">
    
    <title>Planuri de Achiziții - Centrul de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă</title>
...
<body>
    ...
    <main class="main-content" id="main-content">
        <section class="page-header">
            <div class="container">
                <h1>Planuri de Achiziții</h1>
                <p>Planificarea anuală a achizițiilor publice</p>
            </div>
        </section>
