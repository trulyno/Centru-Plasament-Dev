...
<head>
    ...
    <meta name="description" content="<?php echo t('procurement_plans_meta_description'); ?>">
    <meta name="keywords" content="<?php echo t('procurement_plans_meta_keywords'); ?>">
    <meta name="author" content="<?php echo t('meta_author'); ?>">
    
    <title><?php echo t('procurement_plans_page_title'); ?></title>
...
<body>
        ...
        <div class="header-top" id="headerTop">
            ...
            <div class="header-top-container" id="headerTopContainer">
                ...
                <div class="header-contact">
                    ...
                    <!-- Language Selector -->
                    <?php echo getLanguageSelector('planuri-achizitii.php'); ?>
                </div>
            </div>
        </div>
    ...
    <main class="main-content" id="main-content">
        <section class="page-header">
            <div class="container">
                <h1><?php echo t('procurement_plans_header_title'); ?></h1>
                <p><?php echo t('procurement_plans_header_subtitle'); ?></p>
            </div>
        </section>
