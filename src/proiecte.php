...
<head>
    ...
    <meta name="description" content="Proiectele derulate de Centrul de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă.">
    <meta name="keywords" content="proiecte, programe, inițiative">
    <meta name="author" content="Centrul de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă">
    
    <title>Proiecte - Centrul de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă</title>
...
<body>
    ...
    <main class="main-content" id="main-content">
        <section class="page-header">
            <div class="container">
                <h1>Proiecte</h1>
                <p>Proiecte și inițiative pentru dezvoltarea serviciilor</p>
            </div>
        </section>
