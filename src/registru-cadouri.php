...
<head>
    ...
    <meta name="description" content="<?php echo t('gifts_register_meta_description'); ?>">
    <meta name="keywords" content="<?php echo t('gifts_register_meta_keywords'); ?>">
    <meta name="author" content="<?php echo t('meta_author'); ?>">
    
    <title><?php echo t('gifts_register_page_title'); ?></title>
        ...
        <div class="header-top" id="headerTop">
            ...
            <div class="header-top-container" id="headerTopContainer">
                ...
                <div class="header-contact">
                    ...
                    <!-- Language Selector -->
                    <?php echo getLanguageSelector('registru-cadouri.php'); ?>
                </div>
            </div>
        </div>
