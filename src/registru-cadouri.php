...
<head>
    ...
    <meta name="description" content="Registrul cadourilor primite de Centrul de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă.">
    <meta name="keywords" content="registru cadouri, transparență, donații">
    <meta name="author" content="Centrul de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă">
    
    <title>Registru Cadouri - Centrul de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă</title>
...
<body>
    ...
    <main class="main-content" id="main-content">
        <section class="page-header">
            <div class="container">
                <h1>Registru Cadouri</h1>
                <p>Registrul cadourilor primite de personal conform legislației</p>
            </div>
        </section>
