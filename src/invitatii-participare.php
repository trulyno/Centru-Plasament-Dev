...
<head>
    ...
    <meta name="description" content="Invitații de participare la licitații și proceduri de achiziție publică ale Centrului de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă.">
    <meta name="keywords" content="invitații participare, licitații, proceduri achiziție">
    <meta name="author" content="Centrul de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă">
    
    <title>Invitații de Participare - Centrul de Plasament și Reabilitare pentru Copiii de Vârstă Fragedă</title>
...
<body>
    ...
    <main class="main-content" id="main-content">
        <section class="page-header">
            <div class="container">
                <h1>Invitații de Participare</h1>
                <!-- <p>Proceduri de achiziții publice în derulare</p> -->
            </div>
        </section>
        ...
        <section class="content-section">
            <div class="container">
                <div class="content-wrapper">
                    <h2>Invitații de Participare</h2>
